...
public class ToolPlacer implements Placer {
    ...
    public double getX()
    {
        return _view.getFrameX();
    }

    @Override
    public void setX(double aValue)
    {
        _view.setFrameX(aValue);
    }

    @Override
    public double getY()
    {
        return _view.getFrameY();
    }

    @Override
    public void setY(double aValue)
    {
        _view.setFrameY(aValue);
    }
    ...
    {
        _view.setPrefWidth(aValue);
    }

    @Override
    public boolean isPrefHeightSet()
    {
        return _view.isPrefHeightSet();
    }
    ...
    {
        _view.setLocked(aValue);
    }

    @Override
    public String getAutosizing()
    {
        return _view.getAutosizing();
    }

    @Override
    public void setAutosizing(String aValue)
    {
        _view.setAutosizing(aValue);
    }
}
