...
protected void respondUI(ViewEvent anEvent)
{
    ...
    if(anEvent.equals("HollywoodMenuItem")) EditorPaneUtils.openSample("Jar:/reportmill/examples/HollywoodDB.xml");
    if(anEvent.equals("SalesMenuItem")) EditorPaneUtils.openSample("Jar:/reportmill/examples/Sales.xml");
