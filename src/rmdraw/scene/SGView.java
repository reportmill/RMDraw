...
public class SGView extends PropObject implements Cloneable, Archivable, Key.GetSet {
    ...
    {
        setFrame(aRect.x, aRect.y, aRect.width, aRect.height);
    }
    ...
    {
        return getBorder() == null ? Color.BLACK : getBorder().getColor();
    }
    ...
    public void setAutosizing(String aValue)
    {
        if (aValue != null && (aValue.length() < 7 || !(aValue.charAt(0) == '-' || aValue.charAt(0) == '~'))) {
            System.err.println("SGView.setAutosizing: Invalid string: " + aValue);
            return;
        }
     ...
     */
    public void setParent(SGParent aView)
    {
        _parent = aView;
    }
    ...
    {
        return _parent != null ? _parent.getSceneGraph() : null;
    }
    ...
    {
        return _parent != null ? _parent.getPage() : (SGParent) this;
    }
     ...
     * Converts a point from local to given parent.
     */
    public Point localToParent(Point aPoint, SGView aPar)
    {
     ...
     */
    public Point parentToLocal(double aX, double aY, SGView aPar)
    {
     ...
     * Converts a point from given parent to local.
     */
    public Point parentToLocal(Point aPoint, SGView aPar)
    {
     ...
     */
    protected SGView createDivideViewRemainder(byte anEdge)
    {
        return clone();
    }
    ...
    {
        return getClass() == SGParent.class;
    }
    ...
    public void setPropValue(String aPropName, Object aValue)
    {
        ...
        switch (aPropName) {
            ...
            case SkewY_Prop:
                ...
                break;
            case Border_Prop:
                setBorder(aValue instanceof Border ? (Border) aValue : null);
                break;
            case Fill_Prop:
                setFill(aValue instanceof Paint ? (Paint) aValue : null);
                break;
            case Effect_Prop:
    ...
    public Object fromXML(XMLArchiver anArchiver, XMLElement anElement)
    {
        ...
        for (int i = anArchiver.indexOf(anElement, Paint.class); i >= 0; i = -1) {
            ...
            if (e.getName().equals("color") && this instanceof SGText)
                continue; // Bogus till we figure out RMFill to Paint stuff!
