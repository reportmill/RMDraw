...
public class SGText extends SGRect {
     ...
     */
    public SGText(RichText aRichText)
    {
        setRichText(aRichText);
    }

    /**
     * Creates a text instance initialized with the given plain text String.
     */
    public SGText(String plainText)
    {
        getRichText().addChars(plainText);
    }
    ...
    {
        getRichText().replaceChars(aString, 0, length());
    }
    ...
    {
        return getRichText().getRunForCharIndex(0).getColor();
    }
    ...
    private List<SGView> getPeersWhoCauseWrap()
    {
        ...
        for (int i = 0, iMax = getParent().getChildCount(); i < iMax; i++) {
            SGView child = getParent().getChild(i);
     ...
     */
    public SGLinkedText getLinkedText()
    {
        return _linkedText;
    }
    ...
    {
        return anEdge == 0 ? new SGLinkedText(this) : clone();
    }
    ...
    public void copyView(SGView aView)
    {
        ...
        SGText other = aView instanceof SGText ? (SGText) aView : null;
